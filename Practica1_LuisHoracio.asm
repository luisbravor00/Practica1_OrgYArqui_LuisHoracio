...
#int moverTorre(int altura, char origen, char destino, char intermedio) {
#    if (altura >= 1) {
...
moverTorre: 	addi t0, zero, 1
		...
		# push stack -> ra, altura-1, aux, destino, origen
		addi sp, sp, -4		# Cargamos ra
		sw ra, 0(sp)
		addi sp, sp, -4		# Cargamos altura - 1
		sw a2, 0(sp)
		...
		# llamada recursiva
		jal moverTorre
		# pop stack -> origen, destino, aux, altura-1, ra
		lw a3, 0(sp)		# Sacamos origen
		addi sp, sp, 4
		lw a5, 0(sp)		# Sacamos destino
		addi sp, sp, 4
